    ...
    <div class="card">
        <div class="card-body">
            <div style="display: flex; justify-content: space-between;">
                <h4 class="card-title">
                    @lang('crud.finished_product_stocks.index_title')
                </h4>
            </div>
            ...
            <div class="table-responsive">
                <table class="table table-borderless table-hover">
                    ...
                    <tbody>
                        @forelse($finishedProductStocks as
                        $finishedProductStock)
                        <tr>
                            <td>
                                {{ $finishedProductStock->quantity ?? '-' }}
                            </td>
                            <td>
                                {{ $finishedProductStock->validity ?? '-' }}
                            </td>
                            <td>
                                {{
                            ...
                            <td class="text-center" style="width: 134px;">
                                <div
                                    ...
                                    class="btn-group"
                                >
                                    @can('update', $finishedProductStock)
                                    <a
                                        href="{{ route('finished-product-stocks.edit', $finishedProductStock) }}"
                                    >
                                        <button
                                            type="button"
                                            class="btn btn-light"
                                    ...
                                    @endcan @can('view', $finishedProductStock)
                                    <a
                                        href="{{ route('finished-product-stocks.show', $finishedProductStock) }}"
                                    >
                                        <button
                                            type="button"
                                            class="btn btn-light"
                                    ...
                                    $finishedProductStock)
                                    <form
                                        action="{{ route('finished-product-stocks.destroy', $finishedProductStock) }}"
                                        method="POST"
